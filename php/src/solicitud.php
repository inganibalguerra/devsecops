...
<body>
					...
					<div class="container">
						<div class="row marginii">
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
								...
								<h1 class="web_text"><strong>IPREDIAL</strong></h1>
								<p class="donec_text">AQUI VA UN BUEN PACODonec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet orci.
	...
	<div id="about" class="choose_section">
		<div class="container">
			<div class="col-sm-12">
				<h1 class="choose_text">Impuesto <span class="color">PREDIAL</span></h1>
				<p class="lorem_text">AQUI VA OTRO PACO Making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover any web sites still</p>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="power_full">
						...
						<h2 class="powerful_text">Generar recibos de pago</h2>
				...
				<div class="col-sm-4">
					<div class="power">
						...
						<h2 class="totaly_text">Estado de cuenta</h2>
				...
				<div class="col-sm-4">
					<div class="power">
						...
						<h2 class="totaly_text">Realizar Solicitud</h2>
						<p class="making">Aqui Paco making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still </p>
					</div>
					<div class="btn_main">
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-12 col-lg-6">
						...
						<div class="menu multi_column_menu">
							<ul>
								<li class="footer_menu"><a href="#"><img src="images/bulit-icon.png" class="footer_menu">Webhosting</a></li>
								<li class="footer_menu"><a href="#"><img src="images/bulit-icon.png" class="footer_menu">Reseler Hosting</a></li>
								<li class="footer_menu"><a href="#"><img src="images/bulit-icon.png" class="footer_menu">VPS Hosting</a></li>
								<li class="footer_menu"><a href="#"><img src="images/bulit-icon.png" class="footer_menu">Wordpress Hosting</a></li>
								<li class="footer_menu"><a href="#"><img src="images/bulit-icon.png" class="footer_menu">Dedicated hosting</a></li>
								<li class="footer_menu"><a href="#"><img src="images/bulit-icon.png" class="footer_menu">Windows</a></li>
							</ul>
						</div>
